      ...
      return (
        <View style={[{flex:1},styles.pdTop,styles.pdLeft]}>
            ...
            <View style={[styles.center,{flexDirection:'row',height:height/8}]}>
                    <TouchableOpacity
                      style={{flex:1,width:height/8,height:height/8}}
                    >
                        <Image 
                        source={require('./logo.png')}
                        style={{width:height/8,height:height/8,borderRadius:5}}
                        />
                    </TouchableOpacity>
                    <View >
...
const TabNavigator =   createBottomTabNavigator(
    {
      HomeTab:{
        ...
        navigationOptions: {
          tabBarIcon: ({focused, horizontal, tintColor}) => {
            if (focused) {
              return <Text style={{fontSize:22,width: 30, height: 30,color:"#11D6BB"}}>&#xe655;</Text>
            } else {
              return <Text style={{fontSize:22,width: 30, height: 30}}>&#xe655;</Text>
            }
        },
          tabBarOnPress: (event) => {
            //调用组建内默认的实现方法
      ...
      ContactTab:{
        ...
        navigationOptions: {
          tabBarIcon: ({focused, horizontal, tintColor}) => {
            if (focused) {
              return <Text style={{fontSize:24,width: 30, height: 30,color:"#11D6BB"}}>&#xe61c;</Text>
            } else {
                return <Text style={{fontSize:24,width: 30, height: 30}}>&#xe61c;</Text>
            }
        },
          tabBarOnPress: (event) => {
            //调用组建内默认的实现方法
      ...
      ZoneTab:{
        ...
        navigationOptions: {
          tabBarIcon: ({focused, horizontal, tintColor}) => {
            if (focused) {
                return <Text style={{fontSize:25,width: 30, height: 30,color:"#11D6BB"}}>&#xe611;</Text>
            } else {
                return <Text style={{fontSize:25,width: 30, height: 30}}>&#xe611;</Text>
            }
        },
          tabBarOnPress: (event) => {
            //调用组建内默认的实现方法
